...
Register a background sync task using serviceWorker.sync.register().
...
✅ How It Works
Use Push API + Notification API.

Backend uses Web Push Protocol to send a push to the browser.
